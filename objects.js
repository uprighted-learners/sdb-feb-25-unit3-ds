...
const auth = request => {
	...
	if (foundUser.length != 0) {
		...
		if (request.password === foundUser[0].password) {
...
// ? Accessing nested rats nest of object/array

let mess = {
	name: "messy",
	stuff: [
		{ room: "bedroom", things: "cat" },
		{
			room: "bathroom",
			things: ["toothbrush", "toilet paper", "moisturizer"],
		},
	],
};

console.log(mess.stuff[1].things[1]);